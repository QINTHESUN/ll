...
INSERT INTO `sys_attractions` (`id`, `name`, `price`, `introduce`, `content`, `num`, `real_name`, `images`, `open`, `time`, `state`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES ('1777682811382247427', '乌镇', 100.00, '乌镇镇，原名乌墩，隶属于浙江省嘉兴市桐乡市，地处江浙沪“金三角”之地、杭嘉湖平原腹地。乌镇境内水系属太湖流', '乌镇镇，原名乌墩，隶属于浙江省嘉兴市桐乡市，地处江浙沪“金三角”之地、杭嘉湖平原腹地。乌镇境内水系属太湖流', 100, 1, 'http://localhost:8080/img/1718248840599e306cc1221042406507cbc68358f331.png,http://localhost:8080/img/171824884345575e3269f1179eba12d5af9ac32a71e84.jpg', '景区提倡文明出行,请游客朋友们自觉爱护景区花草树木,不攀爬折枝、不采挖植物、不破坏设施标牌,不随地吐痰、不乱扔垃圾。', '全天', 1, '超级管理员', '2024-04-09 20:59:45', '超级管理员', '2024-06-13 11:20:46');
